<template>
  <ion-page>
    <ion-content :fullscreen="true">
      ...
      <div class="container">
        <div class="cards">
          <div class="cards-info" v-for="movie in movieList" :key="movie.id"  @click="goToTrendingDetails(movie.id)">
            <img
              :src="getShowPosterUrl(movie.poster_path)"
              alt=""
              loading="lazy"
            />
            <h1>{{ movie.title }}</h1>
...
const options = {
  ...
  headers: {
    ...
    Authorization:
      'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI0MmMwMmMzYjIxMjQ1MTI1ZGM4MGRjNWY4MWY3NjkxNyIsInN1YiI6IjY1YmE5NzdkMzBmNzljMDE4M2FjNjkyYiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.sTl1YONLh9hBXGMqd1XfeWEKnPYnxrVb6pDxM03ivmg',
  },
};
